...
2. Сборка пакета с помощью команды ```dpkg-deb --build ./package```.
3. Установка собранного пакета в отдельную среду.

## Тестирование пакета
Вторая часть проекта - это тестирование пакета. Для этого мы используем другую джобу, которая выполняет следующие шаги:
1. Установка собранного пакета из предыдущей джобы.
2. Запуск тестов.
3. Удаление установленного пакета.
